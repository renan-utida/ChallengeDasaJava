...
import com.dasa.controller.dao.AtendimentoDao;
...
public class JdbcAtendimentoDao implements AtendimentoDao {
    ...
    private Atendimento mapearAtendimentoCompletoInfo(ResultSet rs) throws SQLException {
        ...
        // Se o status for "Cancelado", mostra "Cancelado" para enfermeiro e técnico
        ...
        } else if ("Atendido".equals(atendimento.getStatus())) {
            // Se não houver info ou for null, mantém "Em espera"
